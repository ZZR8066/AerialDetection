...
model = dict(
    ...
    vertex_roi_extractor=dict(
        ...
        featmap_strides=[8, 16, 32, 64, 128]),
    vertex_head=dict(
        type='FusedVertexFCBBoxHeadRbbox',
        # type='FusedFCBBoxHeadRbbox',
        # type='SharedFCBBoxHeadRbbox',
        num_fcs=2,
        in_channels=256,
        ...
        target_stds=[0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05],
        reg_class_agnostic=False,
        loss_cls=dict(
            type='CrossEntropyLoss', use_sigmoid=False, loss_weight=1.0),
        loss_bbox=dict(type='SmoothL1Loss', beta=1.0, loss_weight=1.0))
...
log_level = 'INFO'
work_dir = '/disk2/zzr/work_dirs/RoITrans_r50_pafpn_V2_atss_head_concat_Vertex_rcnn_1x_dota1_5'
load_from = None
resume_from = None
workflow = [('train', 1)]
