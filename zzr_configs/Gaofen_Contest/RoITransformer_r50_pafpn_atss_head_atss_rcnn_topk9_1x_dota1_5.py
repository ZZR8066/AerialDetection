...
train_cfg = dict(
    ...
    rcnn=[
        ...
        dict(
            ...
            #     ignore_iof_thr=-1),
            assigner=dict(
                type='ATSSAllLevelsAssignerRbbox',
                topk=9),
            sampler=dict(
...
log_level = 'INFO'
work_dir = '/disk2/zzr/work_dirs/RoITrans_r50_pafpn_atss_head_atss_rcnn_topk9_1x_dota1_5'
load_from = None
resume_from = None
workflow = [('train', 1)]
