# model settings
model = dict(
    type='AFSingleAPERoITransformerIoUSmoothLoss',
    ...
    bbox_head=dict(
        type='FusedAPEFCBBoxHeadRbboxIoUSmoothLoss',
...
log_level = 'INFO'
work_dir = '/disk2/zzr/work_dirs/RoITrans_r50_pafpn_V2_atss_head_APE_RCNN_use_IoUSmoothLoss_V2_1x_dota1_5'
load_from = None
resume_from = None
workflow = [('train', 1)]
