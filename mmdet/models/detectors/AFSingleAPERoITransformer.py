...
class AFSingleAPERoITransformer(BaseDetectorNew, RPNTestMixin):
    ...
    def __init__(self,
        ...
        super(AFSingleAPERoITransformer, self).__init__()
    ...
    def init_weights(self, pretrained=None):
        super(AFSingleAPERoITransformer, self).init_weights(pretrained)
