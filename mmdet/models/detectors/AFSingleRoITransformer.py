...
class AFSingleRoITransformer(BaseDetectorNew, RPNTestMixin):
    ...
    def __init__(self,
        ...
        super(AFSingleRoITransformer, self).__init__()
    ...
    def init_weights(self, pretrained=None):
        super(AFSingleRoITransformer, self).init_weights(pretrained)
