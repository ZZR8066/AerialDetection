...
class AF_InLd_RoITransformer(BaseDetectorNew, RPNTestMixin):
    ...
    def __init__(self,
        ...
        super(AF_InLd_RoITransformer, self).__init__()
    ...
    def init_weights(self, pretrained=None):
        super(AF_InLd_RoITransformer, self).init_weights(pretrained)
