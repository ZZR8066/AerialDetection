...
class RotateMaskRCNN(BaseDetectorNew, RPNTestMixin):
    ...
    def __init__(self,
        ...
        super(RotateMaskRCNN, self).__init__()
        ...
        self.mask_rroi_extractor = builder.build_roi_extractor(
                mask_rroi_extractor)
    ...
    def init_weights(self, pretrained=None):
        super(RotateMaskRCNN, self).init_weights(pretrained)
        ...
        self.mask_rroi_extractor.init_weights()
