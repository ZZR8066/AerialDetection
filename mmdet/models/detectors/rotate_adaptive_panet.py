...
from .zzr_function import (mask2obb_mask, det_rbboxes2det_bboxes, rbboxes2rects, tran2mix_mask, draw_gt_obboxes)

@DETECTORS.register_module
class RotateAdaptivePANet(BaseDetectorNew, RPNTestMixin):
    ...
    def __init__(self,
        ...
        super(RotateAdaptivePANet, self).__init__()
    ...
    def init_weights(self, pretrained=None):
        super(RotateAdaptivePANet, self).init_weights(pretrained)
    ...
    def simple_test_rotate_mask(self, x, img_meta, 
        ...
        if det_rbboxes.shape[0] == 0:
            ...
            if self.with_shared_head:
                mask_feats = self.shared_head(mask_feats)
            mask_pred = self.mask_head(mask_feats)
            segm_result = self.mask_head.get_rotate_seg_masks(mask_pred, 
